...
if AUTOUPDATE then
  SourceUpdater(SCRIPT_NAME, version, "raw.github.com", "---------CHANGE THIS---------"..SCRIPT_NAME..".lua", SCRIPT_PATH .. GetCurrentEnv().FILE_NAME, "---------CHANGE THIS--------"..SCRIPT_NAME..".version"):CheckUpdate()
end
...
function OnLoad()
	...
	jungleLib = JungleLib()
		...
		config:addSubMenu("Draw Settings", "drawsettings")
			config:addParam("qrange", "Draw Q Range", SCRIPT_PARAM_ONOFF, false)
			config:addParam("wrange", "Draw W Range", SCRIPT_PARAM_ONOFF, false)
			config:addParam("erange", "Draw E Range", SCRIPT_PARAM_ONOFF, false)
			config:addParam("rrange", "Draw R Range", SCRIPT_PARAM_ONOFF, false)
